    ...
    *****************************************************************************/
    class MfgDebug
    {
        ...
        public      static  canvas                      :LibDebug                       = new LibDebug( false   && MfgSettings.MODE == MfgDebugSettings.MODE_DEBUG );
        ...
        public      static  wall                        :LibDebug                       = new LibDebug( false   && MfgSettings.MODE == MfgDebugSettings.MODE_DEBUG );
        /** The debug group for item handling. */
        public      static  item                        :LibDebug                       = new LibDebug( false   && MfgSettings.MODE == MfgDebugSettings.MODE_DEBUG );
        /** The debug group for managing sounds. */
        public      static  sound                       :LibDebug                       = new LibDebug( false   && MfgSettings.MODE == MfgDebugSettings.MODE_DEBUG );
        /** The debug group for the collision system. */
        public      static  collision                   :LibDebug                       = new LibDebug( false   && MfgSettings.MODE == MfgDebugSettings.MODE_DEBUG );
        /** The debug group for sticky walls. */
        public      static  stickyWalls                 :LibDebug                       = new LibDebug( true    && MfgSettings.MODE == MfgDebugSettings.MODE_DEBUG );
    }
